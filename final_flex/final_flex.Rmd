...
dat <- read_excel("H:\\My Drive\\2758686 Data Vis\\final\\final.xlsx")
...
dat <- mutate(dat, passmid = cut(mid, breaks = 2, labels = c("ไม่ผ่าน", "ผ่าน")),
                  passfin = cut(fin, breaks = 2, labels = c("ไม่ผ่าน", "ผ่าน")))
dat <- data.frame(dat)
